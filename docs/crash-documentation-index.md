...
**Last Updated:** 2026-09-09 (added `crash-investigations/bf-4k2ws/README.md` — the bf-4k2ws final report and knowledge capture (domchk-aea1baca): 62-attempt storm = 55 × exit −1 + 5 × 124 + 2 × 0, classification INFRASTRUCTURE / repository-bloat-era kill regime with the false-positive confined to the alert layer; routes the twelve bannered pre-reclassification corpus files to the canonical determination `investigations/bf-4k2ws-root-cause-determination-domchk-7f838f36-2026-09-07.md`; resolution battery re-verified live 2026-09-09. Prior update 2026-09-08 added `crashes/bf-4yjq-crash-investigation.md` — the canonical consolidated bf-4yjq report, domchk-8b3c1c69, covering the parent deliverables; re-labeled `crash-investigations/bf-4yjq-crash-investigation.md` as the detailed companion record; prior update 2026-09-07 added `root-cause-analysis-bf-1ea4g-2026-08-13.md` — the dispatch-named RCA rendering for domchk-e940d850, cross-registered in the consolidated inventory §5.5; earlier the same day added the bf-1ea4g consolidated inventory to Key Individual Reports — 56-kill `git push` loop across 57 attempts, kill INFRASTRUCTURE / alert FALSE_POSITIVE, corpus claim-conflict matrix, resolution live-verified 2026-09-07; before that 2026-09-06 added the bf-1s6c3 comprehensive crash report and the bf-4yjq final summary and canonical record, classification INFRASTRUCTURE/repository-bloat, remediation deployed and verified, see `crash-summary-bf-4yjq-2026-09-06.md` and `crash-prevention-requirements.md` for the live-verified gap list)  
...
- [`crash-investigations/bf-4k2ws/README.md`](crash-investigations/bf-4k2ws/README.md) - **bf-4k2ws final report / knowledge capture** (domchk-aea1baca, 2026-09-09) — 62-attempt storm 2026-08-13: 55 × exit −1 + 5 × 600s-cap timeouts + 2 verified successes, single worker session; INFRASTRUCTURE (repository-bloat-era kill regime, mechanism chain-inferred via kernel-proven siblings) with the false-positive confined to the alert layer (55 one-per-kill alert beads, pre-dedup); task completed 8/8, closed 2026-08-16, no work lost; corpus router for the twelve bannered pre-reclassification files; canonical determination `investigations/bf-4k2ws-root-cause-determination-domchk-7f838f36-2026-09-07.md`; resolution battery re-verified live 2026-09-09
