# Crash Investigation Report: bf-1zt5b

**Report Date:** 2026-09-01
**Investigation Task:** domchk-c09957bd
**Original Bead:** bf-1zt5b
**Crash Date:** 2026-08-16T14:14:57.130697695+00:00
...
| Field | Value |
|-------|-------|
| **Bead ID** | bf-1zt5b (domchk-c09957bd) |
| **Agent** | claude-code-glm-4.7-lab-roam-4 |
| **Exit Code** | -1 (signal -1) |
| **Signal** | SIGHUP (Signal 1) |
| **Timestamp** | 2026-08-16T14:14:57.130697695+00:00 |
...
- ✅ Loose objects: 116 (< 1000 threshold)
...
| Loose Objects | > 1000 objects | < 100 objects | ✅ 116 objects |
...
- **2026-08-16T14:14:57 UTC**: This crash (bf-1zt5b, later in same cascade)
...
- **bf-9b8oe**: 2026-08-16T12:52:12 UTC (1h 22m earlier)
- **bf-gz3r6**: 2026-08-16T12:59:57 UTC (1h 15m earlier)
...
### Direct Impact
- **Bead Affected**: bf-1zt5b (single crash)
...
| Characteristic | OOM Pattern (bf-4yjq) | SIGHUP Pattern (bf-1zt5b) |
|---------------|---------------------|------------------------|
| Repository Size | 18GB (bloated) | 91MB (healthy) |
| Loose Objects | 17GB (excessive) | 116 (normal) |
...
5. **Temporal Clustering**: Multiple crashes within short time windows (12:52, 12:59, 14:14 on same day) indicate external systemic events rather than workspace-specific issues.
...
- **Related Investigation**: `docs/crash-investigation-bf-gz3r6-2026-08-16.md` (same cascade event, 1h 15m earlier)
- **Related Investigation**: `docs/crash-investigation-bf-9b8oe-2026-08-16.md` (same cascade event, 1h 22m earlier)
...
**Summary**: The crash on bead bf-1zt5b was a **SIGHUP cascade event** caused by external system-level process termination, not a repository health issue or OOM condition.
