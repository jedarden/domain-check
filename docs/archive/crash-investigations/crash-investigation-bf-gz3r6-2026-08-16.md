# Crash Investigation Report: bf-gz3r6

**Report Date:** 2026-09-01
**Investigation Task:** domchk-afc52510
**Original Bead:** bf-gz3r6
**Crash Date:** 2026-08-16T12:59:57.481232976+00:00
...
| Field | Value |
|-------|-------|
| **Bead ID** | bf-gz3r6 (domchk-afc52510) |
| **Agent** | claude-code-glm-4.7-lab-roam-8 |
| **Exit Code** | -1 (signal -1) |
| **Signal** | SIGHUP (Signal 1) |
| **Timestamp** | 2026-08-16T12:59:57.481232976+00:00 |
...
- **2026-08-16T12:59:57 UTC**: This crash (bf-gz3r6, later in same cascade)
...
- **bf-9b8oe**: 2026-08-16T12:42:35 UTC (17 minutes earlier)
...
### Direct Impact
- **Bead Affected**: bf-gz3r6 (single crash)
...
| Characteristic | OOM Pattern (bf-4yjq) | SIGHUP Pattern (bf-gz3r6) |
|---------------|---------------------|------------------------|
| Repository Size | 18GB (bloated) | 90MB (healthy) |
| Loose Objects | 17GB (excessive) | 37 (normal) |
...
5. **Temporal Clustering**: Multiple crashes within short time windows (12:42, 12:59 on same day) indicate external systemic events rather than workspace-specific issues.
...
- **Related Investigation**: `docs/crash-investigation-bf-9b8oe-2026-08-16.md` (same cascade event, 17 min earlier)
...
**Summary**: The crash on bead bf-gz3r6 was a **SIGHUP cascade event** caused by external system-level process termination, not a repository health issue or OOM condition.
