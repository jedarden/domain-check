# Crash Investigation Report: bf-1rgs4

**Report Date:** 2026-09-01
**Investigation Task:** domchk-d6e54829
**Original Bead:** bf-1rgs4
**Crash Date:** 2026-08-16T13:30:13.582592715+00:00
...
| Field | Value |
|-------|-------|
| **Bead ID** | bf-1rgs4 (domchk-d6e54829) |
| **Agent** | claude-code-glm-4.7 |
| **Exit Code** | -1 (signal -1) |
| **Signal** | SIGHUP (Signal 1) |
| **Timestamp** | 2026-08-16T13:30:13.582592715+00:00 |
...
Mem:           62Gi       20Gi        19Gi        17Mi        22Gi        41Gi
```
...
- **2026-08-16T12:59:57 UTC**: bf-gz3r6 crash (earlier in same cascade)
- **2026-08-16T13:14:57 UTC**: bf-oplew crash (mid-cascade)
- **2026-08-16T13:30:13 UTC**: This crash (bf-1rgs4, later in same cascade)
...
- **bf-gz3r6**: 2026-08-16T12:59:57 UTC (15 seconds earlier)
- **bf-oplew**: 2026-08-16T13:14:57 UTC (15 minutes earlier)
- **bf-1rgs4**: 2026-08-16T13:30:13 UTC (this crash)
...
### Direct Impact
- **Bead Affected**: bf-1rgs4 (single crash)
...
- **Affected Workers**: lab-domain-check, lab-roam-8, lab-roam-7, lab-drawrace, lab-test-fix
...
| Characteristic | OOM Pattern (bf-4yjq) | SIGHUP Pattern (bf-1rgs4) |
|---------------|---------------------|------------------------|
| Repository Size | 18GB (bloated) | 91MB (healthy) |
| Loose Objects | 17GB (excessive) | 70 (normal) |
...
5. **Temporal Clustering**: Multiple crashes within short time windows (12:42, 12:59, 13:14, 13:30 on same day) indicate external systemic events rather than workspace-specific issues.
...
$ free -h | grep "^Mem:"
Mem:           62Gi       20Gi        19Gi        17Mi        22Gi        41Gi  ✅ Available (66%)
```
...
- **Related Investigation**: `docs/crash-investigation-bf-gz3r6-2026-08-16.md` (same cascade event, 30 min earlier)
- **Related Investigation**: `docs/crash-investigation-bf-oplew-2026-08-16.md` (same cascade event, 15 min earlier)
- **Related Investigation**: `docs/crash-investigation-bf-9b8oe-2026-08-16.md` (same cascade event, earlier)
...
**Summary**: The crash on bead bf-1rgs4 was a **SIGHUP cascade event** caused by external system-level process termination, not a repository health issue or OOM condition.
