...
From related crash investigations on the same day:
...
### Similarities to bf-1s6c3 (Original Crash Being Reported)

| Aspect | bf-1s6c3 | bf-3lwth |
|--------|----------|----------|
| Exit code | -1 | -1 |
| Nature | Task bead | Alert bead (meta-level) |
| Date | 2026-08-12 | 2026-08-16 |
| Context | Git reconciliation timeout | CPU saturation during crash event |
| Daily crash volume | 455 | 826 |
| Relationship | Original crash | Alert about original crash |

### Similarities to Other 2026-08-16 Crashes

| Aspect | bf-3lwth | bf-xumcu | bf-31p3g |
|--------|----------|----------|----------|
| Exit code | -1 | -1 | -1 |
| Date | 2026-08-16 | 2026-08-16 | 2026-08-16 |
| CPU saturation | Very high (1.9x-2.7x) | Very high (2.46x-4.64x) | Very high (2.78x) |
| Crashes per bead | 3+ | 3 | 1 |
| Worker | lab-domain-check | lab-domain-check | lab-test-fix |
| Workspace | domain-check | domain-check | pdftract |

**Key similarity:** All beads on 2026-08-16 experienced crashes during extreme CPU saturation as part of the 826-crash event.
...
**Session persistence:** All crashes used the same session ID (b7afe97d), indicating the worker maintained state across crashes but didn't successfully complete the task.
