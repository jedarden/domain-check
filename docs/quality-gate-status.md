...
| Field | Value |
|-------|-------|
| **Workflow Name** | `domain-check-build-ttmq5` |
| **Workflow Phase** | Failed |
| **Overall Message** | `child 'domain-check-build-ttmq5-3918048181' failed` |
| **Age** | ~2m47s (captured 2026-07-03) |

## Quality-Gate Node Details

| Field | Value |
|-------|-------|
| **Node ID** | `domain-check-build-ttmq5-3918048181` |
| **Node Name** | `build-quality-gate` |
| **Node Type** | Pod |
| **Phase** | **Failed** |
| **Exit Code** | (none reported at node level — reported as `main: Error (exit code 2)`) |
| **Message** | `main: Error (exit code 2)` |

## Node Tree

```
domain-check-build-ttmq5 (Steps) — Failed
  └── [0] (StepGroup) — Failed
...
| Workflow | Phase | Quality-Gate Message |
|----------|-------|---------------------|
| `domain-check-build-ttmq5` | Failed | `main: Error (exit code 2)` |
| `domain-check-build-debug-qg-jz8k9` | Failed | `main: Error (exit code 2)` |
| `domain-check-build-debug-qg-hkst6` | Error | `pods ... is forbidden: error looking up service account argo-workflows/github-auth: serviceaccount "github-auth" not found` |
| `domain-check-build-debug-qg-wl5sw` | Failed | child failed |
| `domain-check-build-jxwhw` | Failed | child failed |
| `domain-check-build-hsrx2` | Failed | child failed |
| `domain-check-build-debug-qg-h89zn` | Failed | child failed |
| `domain-check-build-45dk7` | Failed | child failed |
| `domain-check-build-debug-qg-78gw7` | Succeeded | — |
